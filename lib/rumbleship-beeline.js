...
class RumbleshipBeeline {
    ...
    startTrace(span_data, traceId, parentSpanId, dataset) {
        ...
        RumbleshipBeeline.TrackedContextbyContextId.set(this.context_id, (_a = RumbleshipBeeline.HnyTracker) === null || _a === void 0 ? void 0 : _a.getTracked());
        return trace;
    }
    finishTrace(span) {
        var _a;
        ...
        (_a = RumbleshipBeeline.HnyTracker) === null || _a === void 0 ? void 0 : _a.deleteTracked();
    }
