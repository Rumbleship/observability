...
exports.AddToTrace = exports.WithSpan = void 0;
...
function AddToTrace(span_metadata = {}) {
    return (target, propertyName, descriptor) => {
        ...
        descriptor.value = function (...args) {
            var _a, _b, _c;
            const { beeline, id, logger } = findContextWithBeelineFrom(args !== null && args !== void 0 ? args : []) || // if this is a resolver, with @Ctx injected
                this.ctx || // if this is a service
            ...
            if (beeline) {
                ...
                if (beeline.traceActive()) {
                    ...
                    if (context) {
                        (_c = rumbleship_beeline_1.RumbleshipBeeline.HnyTracker) === null || _c === void 0 ? void 0 : _c.setTracked(context);
...
function findContextWithBeelineFrom(args) {
    return args.find(arg => !!(arg && arg.beeline instanceof rumbleship_beeline_1.RumbleshipBeeline));
}
