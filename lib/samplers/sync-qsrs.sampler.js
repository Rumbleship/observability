...
class SyncQsrsSampler extends deterministic_sampler_1.DeterministicSampler {
    ...
    sample(event_data) {
        ...
        if (name === 'resolve' && (gcloud_topic_name === null || gcloud_topic_name === void 0 ? void 0 : gcloud_topic_name.match(/^[\w-]+_GRAPHQL_REQUEST$/)) && (gcloud_subscription_name === null || gcloud_subscription_name === void 0 ? void 0 : gcloud_subscription_name.match(/^[\w-]+_GRAPHQL_REQUEST_orders$/)) && (publish_to_topic_name === null || publish_to_topic_name === void 0 ? void 0 : publish_to_topic_name.match(/^[\w-]+_GRAPHQL_RESPONSE_\w+$/)) &&
